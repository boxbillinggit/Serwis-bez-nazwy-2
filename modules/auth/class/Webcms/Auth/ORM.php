...
class Webcms_Auth_ORM extends Auth {
...
#ORM::factory('role', array('name' => 'login')) na ORM::factory('role')->where('name' , '=' , 'login')->find()
		// If the passwords match, perform a login
		if ($user->has('roles', ORM::factory('role')->where('name' , '=' , 'login')->find()) AND $user->password === $password)
		{
			if ($remember === TRUE)
			{
