 ...
 */
abstract class Webcms_Database_Result implements Countable, Iterator,SeekableIterator, ArrayAccess {
	 ...
	 *
	 * @throws  Webcms_Database_Exception
	 */
	final public function offsetSet($offset, $value)
	{
		throw new Webcms_Exception('Database results are read-only');
	}
