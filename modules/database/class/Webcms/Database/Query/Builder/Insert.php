 ...
 */
class Webcms_Database_Query_Builder_Insert extends Database_Query_Builder {
	...
	public function values(array $values)
	{
		...
		{
			throw new Webcms_Exception('INSERT INTO ... SELECT statements cannot be combined with INSERT INTO ... VALUES');
		}
	...
	public function select(Database_Query $query)
	{
		...
		{
			throw new Webcms_Exception('Only SELECT queries can be combined with INSERT queries');
		}
