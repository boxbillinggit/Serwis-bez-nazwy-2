			...
			<div class="panel-body">
				...
				<form role="form" class="form-horizontal form-groups-bordered">
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<textarea class="form-control autogrow" id="field-ta" placeholder="I will grow as you type new lines." style="overflow: hidden; word-wrap: break-word; resize: horizontal; height: 48px;"></textarea>
						</div>
					</div>
