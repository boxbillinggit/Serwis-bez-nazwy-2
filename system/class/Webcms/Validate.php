 ...
 */
class Webcms_Validate extends ArrayObject {
	...
	public static function credit_card($number, $type = NULL)
	{
		...
		$cards = Webcms::config('credit_cards');
	...
	public function errors($file = NULL, $translate = TRUE)
	{
		...
		foreach ($this->_errors as $field => $set)
		{
			...
			if ($message = Webcms::message($file, "{$field}.{$error}"))
			{
				// Found a message for this field and error
			}
			elseif ($message = Webcms::message($file, "{$field}.default"))
			{
				// Found a default message for this field
			}
			elseif ($message = Webcms::message('validate', $error))
			{
